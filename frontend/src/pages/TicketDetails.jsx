          ...
          <div className="flex items-center gap-3">
            {status === "OPEN" && (
              <button 
                onClick={handleAck}
                disabled={sending}
                className="flex items-center gap-2 px-6 py-2.5 bg-amber-50 text-amber-700 border border-amber-200 rounded-xl font-bold text-xs hover:bg-amber-100 transition-all active:scale-95 disabled:opacity-50"
              >
            ...
            {!isResolved && (
              <button 
                ...
                disabled={sending}
                className="flex items-center gap-2 px-6 py-2.5 bg-emerald-600 text-white rounded-xl font-bold text-xs hover:bg-emerald-700 shadow-lg shadow-emerald-100 transition-all active:scale-95 disabled:opacity-50"
              >
